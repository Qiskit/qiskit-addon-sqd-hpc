...
- Optional shared-memory parallelism: when compiled with OpenMP, `recover_configurations` corrects bitstrings in parallel, and with a counter-based generator the result is reproducible regardless of the number of threads.
